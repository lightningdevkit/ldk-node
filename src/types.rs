...
///   backend type
///
/// Implementations are also expected to support exhaustive key enumeration
/// mirroring [`lightning::util::persist::MigratableKVStore`], so the same
/// erased store abstraction can be used for migration and restoration.

...
impl Wallet {
	...
	/// is not touched beyond the entry a failure cut short left behind. `resolution` names the
...
/// after `ChannelClosed`, but the monitor keeps watching every pending round the counterparty's

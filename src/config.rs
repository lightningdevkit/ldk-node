...
pub struct Config {
	...
	///
	/// **Note** If set to `Some`, you must ensure that the Bitcoin node used to broadcast
	/// transactions relays TRUC, P2A, and ephemeral dust. Bitcoin Core v29 and above satisfy
	/// this requirement. Esplora chain sources also need to support the `/txs/package`
	/// endpoint, and Electrum chain sources need to support the `broadcast_package` method
